    ...
    <div className="absolute inset-0 pointer-events-none flex flex-col">
       ...
       <div className="p-10 flex justify-between items-start pointer-events-auto">
          ...
          <div className="flex flex-col items-end gap-2">
             ...
             {amount !== undefined && amount !== "" && (
               <div className="text-[#34DA4F] font-black text-3xl tracking-tighter mt-1 bg-slate-900/80 px-6 py-2 rounded-2xl shadow-2xl border border-white/5">
                 ${amount}
               </div>
             )}
          </div>
       ...
       <div className="flex-1 flex items-center justify-center p-12">
         <div className="relative w-full aspect-square max-w-[280px]">
           {/* 四個角落的弧形 - 營造圓形感 */}
           <div className="absolute top-0 left-0 w-16 h-16 border-t-4 border-l-4 border-[#34DA4F] rounded-tl-[3rem] opacity-60" />
           <div className="absolute top-0 right-0 w-16 h-16 border-t-4 border-r-4 border-[#34DA4F] rounded-tr-[3rem] opacity-60" />
           <div className="absolute bottom-0 left-0 w-16 h-16 border-b-4 border-l-4 border-[#34DA4F] rounded-bl-[3rem] opacity-60" />
           <div className="absolute bottom-0 right-0 w-16 h-16 border-b-4 border-r-4 border-[#34DA4F] rounded-br-[3rem] opacity-60" />
           ...
           {(scanState === "scanning-a" || scanState === "scanning-b") && (
             <div className="absolute top-1/2 left-0 w-full h-[3px] bg-gradient-to-r from-transparent via-[#34DA4F] to-transparent shadow-[0_0_20px_#34DA4F] animate-[scan_2.5s_ease-in-out_infinite] -translate-y-1/2" />
           )}
           
           {scanState === "success" && (
             <div className="absolute inset-0 bg-[#34DA4F]/10 flex items-center justify-center backdrop-blur-sm animate-in fade-in zoom-in duration-500 pointer-events-auto rounded-full">
                <div className="bg-white rounded-full p-6 shadow-[0_20px_50px_rgba(52,199,89,0.3)] animate-in bounce-in duration-700">
                   <CheckCircle2 size={72} className="text-[#34DA4F]" />
                </div>
             </div>
           )}
